...
; call gate descriptor
	...
	shr eax, 16
	mov word[ebx+6], ax
	mov word[ebx+2], LDT2_CODE_SEL_0
...
; control transfer
	call LDT2_Call_Gate:0	;There is no meaning for offset in far call/jump the call gate register
; print strings
	mov edi, 80*2*8+2*0					
