...
;------------------------------------------------------------------------------------	
	...
	mov ebx, tss1
	mov word[ebx+96], LDTR1
	mov word[ebx+76], LDT_CODE_SEL1
	mov word[ebx+84], LDT_DATA_SEL1
	mov word[ebx+80], LDT_DATA_SEL1
	mov word[ebx+72], Video_SEL
	mov dword[ebx+32], Task1
	mov dword[ebx+56], 0xa000

	mov ebx, tss2
	mov word[ebx+96], LDTR2
	mov word[ebx+76], LDT_CODE_SEL2
	mov word[ebx+84], LDT_DATA_SEL2
	mov word[ebx+80], LDT_DATA_SEL2
	mov word[ebx+72], Video_SEL
	mov dword[ebx+32], Task2
	mov dword[ebx+56], 0xb000

	mov ebx, tss3
	mov word[ebx+96], LDTR3
	mov word[ebx+76], LDT_CODE_SEL3_0
	mov word[ebx+84], LDT_DATA_SEL3
	mov word[ebx+80], LDT_DATA_SEL3
	mov word[ebx+72], Video_SEL
	mov dword[ebx+32], Task3
	mov dword[ebx+56], 0xc000
